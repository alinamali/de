...
### 3.1. Создайте пользователя sshuser на серверах HQ-SRV и BR-SRV
### 3.1.1. Пароль пользователя  sshuser с паролем P@ssw0rd
### 3.1.2. Идентификатор пользователя 2026
...
### 5.2. Разрешите подключения только пользователю sshuser
